...
Simple board to display a greeting message. Built with Ruby on Rails, PostgreSQL, React, and Redux.
...
```
  git clone git@github.com:Camilovelag/hello-rails-react.git
...
Feel free to check the [issues page](https://github.com/Camilovelag/hello-rails-react/issues).
